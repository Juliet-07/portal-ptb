        ...
        <div className="bg-white rounded-2xl shadow-2xl flex w-2/3 max-w-4xl">
          <div className="w-3/5 p-5">
            <div className="text-left font-bold">
              <span className="text-red-700">Company</span>Name
            </div>
            <div className="py-10">
              <h2 className="text-3xl font-bold text-red-700 mb-2">
                Sign in to Account
              </h2>
              <div className="border-2 w-10 border-red-700 inline-block mb-10"></div>
              ...
              <div className="flex flex-col items-center">
                ...
                <div className="bg-gray-100 w-64 p-2 flex items-center mb-10">
          ...
          <div className="w-2/5 bg-red-700 text-white rounded-tr-2xl rounded-br-2xl py-36 px-12">
            ...
            <div className="border-2 w-10 border-black inline-block mb-10"></div>
            <p className="mb-10">
